...
import FieldWithLabelerror from "./field-with-labelerror";
import Button from "./button";
import AccessThroughInstitutionContai from "./access-through-institution-contai";
import styles from "./sign-up-form1.module.css";
const SignUpForm1: FunctionComponent = () => {
  return (
    <div className={styles.rectangleParent}>
      ...
      <div className={styles.frameParent}>
        <div className={styles.frameGroup}>
          ...
          />
          <FieldWithLabelerror
            emailAddress="Password is wrong"
            viewFill="/view-fill1.svg"
            fieldWithLabelerrorWidth="24.75rem"
            fieldWithLabelerrorHeight="4rem"
            emailAddressTop="0rem"
            emailAddressLeft="0rem"
            emailAddressLineHeight="1rem"
            emailAddressColor="#ffa1b8"
            field40defaultdropdownTop="1.5rem"
            field40defaultdropdownRight="0rem"
            field40defaultdropdownLeft="0rem"
            field40defaultdropdownHeight="2.5rem"
            rectangleDivTop="0rem"
            rectangleDivRight="0rem"
            rectangleDivBottom="0rem"
            rectangleDivLeft="0rem"
            rectangleDivBackgroundColor="unset"
            rectangleDivBorder="1px solid var(--red-30)"
            emailLeft="0.75rem"
            emailLineHeight="1.5rem"
            emailColor="#ffa1b8"
            viewFillIconTop="0.5rem"
        ...
        <AccessThroughInstitutionContai imageDimensions="/line-1.svg" />
      </div>
    </div>
  );
};
